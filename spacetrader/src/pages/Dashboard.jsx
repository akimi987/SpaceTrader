      ...
      <div className="page">
        <section className="menu">
          ...
          <div className="menu__link">
            <h3 className="h3__title"> MANAGER </h3>
        ...
        <section className="dashboard">
          <h2 className="h2__title"> Mon tableau de bord</h2>
          <div className="dashboard__divs">
            <div className="dashboard__ships">
              <h3 className="h3__title"> Mes vaissaux</h3>
              {shipData ? (
            ...
            <div className="dashboard__cargo">
              <h3 className="h3__title">Minerais wallet</h3>
              {shipData ? (
